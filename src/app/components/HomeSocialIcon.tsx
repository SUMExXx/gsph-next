...
const HomeSocialIcon = ({platform, url, color, icon} : HomeSocialIconIterface) => {
    return (
        <Link className={`rounded-full border p-2 md:p-3 flex items-center justify-center border-[${color}]`} href={url} title={platform} style={{ borderColor: color }} target="_blank">
