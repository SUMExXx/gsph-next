...
function SponsorsCard({image, name, link}: SponsorsCardProps) {
  return (
    <Link href={link} target='_blank' rel='noreferrer' className='sponsors-content-div flex flex-col content-center items-center p-[10px] rounded-[20px] hover:shadow-2xl transform transition duration-500' style={{boxShadow: '0px 4px 75px 0px rgba(0, 0, 0, 0.25)'}}>
