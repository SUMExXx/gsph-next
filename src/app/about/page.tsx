    ...
    return(
        <div className="w-full flex flex-col items-center">
            <div className="w-full h-[200px]">
                ...
                <div className="font-black relative w-full bg-[#FAFAFA] mix-blend-screen h-[200px] text-center flex flex-col justify-center items-center">
            ...
            <div className="flex flex-col justify-center items-center gap-10 p-10">
                <h1 className="font-bold text-4xl">Our Mentors</h1>
                <div className="flex flex-wrap gap-10 justify-center items-center">
                    {
                        mentors.map((mentor, index) => (
                            <div key={index} className='flex flex-col content-center items-center p-[10px] rounded-[20px] hover:shadow-2xl transform transition duration-500' style={{boxShadow: '0px 4px 75px 0px rgba(0, 0, 0, 0.25)'}}>
