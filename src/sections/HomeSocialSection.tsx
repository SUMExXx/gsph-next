        ...
        <div className="flex flex-wrap md:gap-24 gap-8">
            {
              socialMediaReach.map(item =>(
                <Link href={item.url} target='_blank' key={m++} className="md:rounded-3xl rounded-lg py-2 md:py-10 px-6 md:px-20 bg-white flex flex-col md:gap-4 gap-2 justify-center items-center" style={{boxShadow: '0px 4px 75px 0px rgba(0, 0, 0, 0.25)'}}>
